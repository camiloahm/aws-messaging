...
public class SNSController {
    ...
    void write(@RequestBody String notificationData) {
        try {
            ...
            log.info("Sending a message 1 to SNS. with Spring Template\n");
            ...
            log.info("Sending a message 2 to SNS. with AWS API directly \n");
            ...
            log.error("Caught an AmazonServiceException, which means " +
                    "your request made it to Amazon SNS, but was " +
